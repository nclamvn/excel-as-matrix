...
export const NAVIGATION_SHORTCUTS: Shortcut[] = [
  ...
  },
  {
    id: 'nav.ctrl.left',
    keys: 'ctrl+ArrowLeft',
    description: 'Jump to left of data region',
    category: 'navigation',
    action: 'JUMP_LEFT',
  },
  {
    ...
    description: 'Jump to right of data region',
    category: 'navigation',
    action: 'JUMP_RIGHT',
  },
...

  {
    id: 'nav.home',
    keys: 'Home',
    description: 'Go to beginning of row',
    category: 'navigation',
    action: 'GO_ROW_START',
  },
  {
    id: 'nav.end',
    keys: 'End',
    description: 'Go to end of row data',
    category: 'navigation',
    action: 'GO_ROW_END',
  },
  {
...
export const SELECTION_SHORTCUTS: Shortcut[] = [
  ...
  {
    id: 'sel.ctrl.shift.up',
    keys: 'ctrl+shift+ArrowUp',
    description: 'Extend to top of region',
    category: 'selection',
    action: 'EXTEND_JUMP_UP',
  },
  {
    id: 'sel.ctrl.shift.down',
    keys: 'ctrl+shift+ArrowDown',
    description: 'Extend to bottom of region',
    category: 'selection',
    action: 'EXTEND_JUMP_DOWN',
  },
  {
    id: 'sel.ctrl.shift.left',
    keys: 'ctrl+shift+ArrowLeft',
    description: 'Extend to left of region',
    category: 'selection',
    action: 'EXTEND_JUMP_LEFT',
  },
  {
    id: 'sel.ctrl.shift.right',
    keys: 'ctrl+shift+ArrowRight',
    description: 'Extend to right of region',
    category: 'selection',
    action: 'EXTEND_JUMP_RIGHT',
  },
...

  {
    ...
    category: 'selection',
    action: 'EXTEND_PAGE_UP',
  },
  {
    id: 'sel.shift.pagedown',
    keys: 'shift+PageDown',
    description: 'Extend selection page down',
    category: 'selection',
    action: 'EXTEND_PAGE_DOWN',
  },

  {
    id: 'sel.shift.home',
    keys: 'shift+Home',
    description: 'Extend to row start',
    category: 'selection',
    action: 'EXTEND_ROW_START',
  },
  {
    id: 'sel.shift.end',
    keys: 'shift+End',
    description: 'Extend to row end',
    category: 'selection',
    action: 'EXTEND_ROW_END',
  },
  {
    id: 'sel.ctrl.shift.home',
    keys: 'ctrl+shift+Home',
    description: 'Extend to A1',
    category: 'selection',
    action: 'EXTEND_START',
  },
  {
    id: 'sel.ctrl.shift.end',
    keys: 'ctrl+shift+End',
    description: 'Extend to last cell',
    category: 'selection',
    action: 'EXTEND_END',
  },
];
...
export const EDITING_SHORTCUTS: Shortcut[] = [
...

  {
    ...
    category: 'editing',
    action: 'TOGGLE_ABSOLUTE',
    when: 'editing',
  },
  {
    id: 'edit.ctrl.shift.enter',
    keys: 'ctrl+shift+Enter',
    description: 'Enter array formula',
    category: 'editing',
    action: 'ARRAY_FORMULA',
    when: 'editing',
  },
  ...
  {
    id: 'edit.ctrl.shift.plus',
    keys: 'ctrl+shift++',
    description: 'Insert row/column',
    category: 'editing',
    action: 'INSERT_ROW_COL',
  },
];
...
export const VIEW_SHORTCUTS: Shortcut[] = [
  ...
  },
  {
    ...
    category: 'view',
    action: 'FREEZE_TOP_ROW',
  },
  {
    id: 'view.freeze.col',
    keys: 'alt+w f c',
    description: 'Freeze first column',
    category: 'view',
    action: 'FREEZE_FIRST_COL',
  },

  {
    id: 'view.formula.bar',
    keys: 'ctrl+shift+u',
    description: 'Toggle formula bar',
    category: 'view',
    action: 'TOGGLE_FORMULA_BAR',
  },
  {
    id: 'view.gridlines',
    keys: 'ctrl+shift+8',
    description: 'Toggle gridlines',
    category: 'view',
    action: 'TOGGLE_GRIDLINES',
  },
