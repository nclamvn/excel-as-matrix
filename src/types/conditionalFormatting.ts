...
// Top/Bottom types
export type CFTopBottomType = 'top' | 'bottom' | 'topPercent' | 'bottomPercent';
...
export const DATA_BAR_PRESETS: CFPreset[] = [
  // Gradient fills
  {
    ...
    name: 'Blue Gradient',
    type: 'dataBar',
    preview: 'linear-gradient(90deg, #5B9BD5 0%, #DEEBF7 100%)',
    config: {
      dataBar: {
        fillType: 'gradient',
        positiveColor: '#5B9BD5',
  ...
  {
    id: 'db-gradient-green',
    name: 'Green Gradient',
    type: 'dataBar',
    preview: 'linear-gradient(90deg, #70AD47 0%, #E2EFDA 100%)',
    config: {
      dataBar: {
        fillType: 'gradient',
  ...
  },
  {
    ...
    name: 'Red Gradient',
    type: 'dataBar',
    preview: 'linear-gradient(90deg, #FF6B6B 0%, #FFE6E6 100%)',
    config: {
      dataBar: {
        fillType: 'gradient',
        positiveColor: '#FF6B6B',
        negativeColor: '#5B9BD5',
        showValue: true,
        minType: 'auto',
        maxType: 'auto',
        direction: 'ltr',
  ...
  {
    id: 'db-gradient-orange',
    name: 'Orange Gradient',
    type: 'dataBar',
    preview: 'linear-gradient(90deg, #ED7D31 0%, #FCE4D6 100%)',
    config: {
      dataBar: {
        fillType: 'gradient',
        positiveColor: '#ED7D31',
        negativeColor: '#5B9BD5',
        showValue: true,
        minType: 'auto',
        maxType: 'auto',
  ...
  {
    id: 'db-gradient-purple',
    name: 'Purple Gradient',
    type: 'dataBar',
    preview: 'linear-gradient(90deg, #7030A0 0%, #E4DFEC 100%)',
    config: {
      dataBar: {
        fillType: 'gradient',
        positiveColor: '#7030A0',
        negativeColor: '#70AD47',
        showValue: true,
        minType: 'auto',
        maxType: 'auto',
        direction: 'ltr',
  ...
  },
  {
    ...
    name: 'Cyan Gradient',
    type: 'dataBar',
    preview: 'linear-gradient(90deg, #00B0F0 0%, #DEEAF6 100%)',
    config: {
      dataBar: {
        fillType: 'gradient',
        positiveColor: '#00B0F0',
        negativeColor: '#FF6B6B',
        showValue: true,
        minType: 'auto',
        maxType: 'auto',
...
export const COLOR_SCALE_PRESETS: CFPreset[] = [
  // 2-color scales
  {
    id: 'cs-2-green-yellow',
    name: 'Green - Yellow',
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #63BE7B 0%, #FFEB84 100%)',
    config: {
      colorScale: {
        type: '2-color',
        minType: 'min',
  ...
  },
  {
    ...
    name: 'Red - Yellow',
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #F8696B 0%, #FFEB84 100%)',
    config: {
      colorScale: {
        type: '2-color',
        minType: 'min',
  ...
  },
  {
    ...
    name: 'Green - White',
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #63BE7B 0%, #FFFFFF 100%)',
    config: {
      colorScale: {
        type: '2-color',
        minType: 'min',
  ...
  },
  {
    ...
    name: 'Red - White',
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #F8696B 0%, #FFFFFF 100%)',
    config: {
      colorScale: {
        type: '2-color',
        minType: 'min',
  ...
  },
  {
    ...
    name: 'Blue - White',
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #5A8AC6 0%, #FFFFFF 100%)',
    config: {
      colorScale: {
        type: '2-color',
        minType: 'min',
  ...
  },
  {
    ...
    name: 'White - Red',
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #FFFFFF 0%, #F8696B 100%)',
    config: {
      colorScale: {
        type: '2-color',
        minType: 'min',
  ...
  // 3-color scales
  {
    ...
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #63BE7B 0%, #FFEB84 50%, #F8696B 100%)',
    config: {
      colorScale: {
        type: '3-color',
        minType: 'min',
  ...
  },
  {
    ...
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #F8696B 0%, #FFEB84 50%, #63BE7B 100%)',
    config: {
      colorScale: {
        type: '3-color',
        minType: 'min',
  ...
  },
  {
    ...
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #63BE7B 0%, #FFFFFF 50%, #63BE7B 100%)',
    config: {
      colorScale: {
        type: '3-color',
        minType: 'min',
  ...
  },
  {
    ...
    name: 'Red - White - Red',
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #F8696B 0%, #FFFFFF 50%, #F8696B 100%)',
    config: {
      colorScale: {
        type: '3-color',
        minType: 'min',
  ...
  },
  {
    ...
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #63BE7B 0%, #FFFFFF 50%, #F8696B 100%)',
    config: {
      colorScale: {
        type: '3-color',
        minType: 'min',
  ...
  },
  {
    ...
    type: 'colorScale',
    preview: 'linear-gradient(90deg, #F8696B 0%, #FFFFFF 50%, #63BE7B 100%)',
    config: {
      colorScale: {
        type: '3-color',
        minType: 'min',
...
export const ICON_SET_DEFINITIONS: IconSetDefinition[] = [
  ...
  {
    id: '3TrafficLightsRim',
    name: '3 Traffic Lights (Rim)',
    category: 'shapes',
    icons: ['🟢', '🟡', '🔴'],
    defaultThresholds: [67, 33],
  },
...
export const HIGHLIGHT_STYLES: { name: string; style: CFStyle }[] = [
  {
    name: 'Light Red Fill with Dark Red Text',
    style: { backgroundColor: '#FFC7CE', textColor: '#9C0006' },
  },
  {
    name: 'Yellow Fill with Dark Yellow Text',
    style: { backgroundColor: '#FFEB9C', textColor: '#9C6500' },
  },
  {
    name: 'Green Fill with Dark Green Text',
    style: { backgroundColor: '#C6EFCE', textColor: '#006100' },
  },
