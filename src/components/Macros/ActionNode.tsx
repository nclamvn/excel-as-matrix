    ...
    <div className={`action-node ${!step.enabled ? 'disabled' : ''}`}>
      ...
      <div className="node-content">
        <div className="node-header" onClick={() => setExpanded(!expanded)}>
          ...
          <span className="action-name">{step.label || getActionLabel(step.action.type)}</span>
          <svg
            width="14"
            height="14"
            viewBox="0 0 24 24"
        ...
        <div className="node-actions">
          ...
          <button type="button" className="action-btn remove" onClick={onRemove} title="Remove">
            <svg
              width="12"
              height="12"
              viewBox="0 0 24 24"
