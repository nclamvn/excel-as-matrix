...
export const MacroLibrary: React.FC<MacroLibraryProps> = ({ macros, onRun, onEdit, onDelete }) => {
      ...
      {macros.map((macro) => (
        <div key={macro.id} className={`macro-card ${!macro.enabled ? 'disabled' : ''}`}>
          <div className="macro-card-header">
            ...
            <div className="macro-info">
              ...
              <div className="macro-meta">
                ...
                <span className="step-count">{macro.workflow.steps.length} steps</span>
              </div>
            </div>
          </div>

          {macro.description && <p className="macro-description">{macro.description}</p>}
          ...
          <div className="macro-actions">
            ...
            <button type="button" className="edit-btn" onClick={() => onEdit(macro)}>
              <svg
                width="14"
                height="14"
                viewBox="0 0 24 24"
            ...
            <button type="button" className="delete-btn" onClick={() => onDelete(macro.id)}>
              <svg
                width="14"
                height="14"
                viewBox="0 0 24 24"
