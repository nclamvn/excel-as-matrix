        ...
        <div className="schedule-config">
          <div className="config-row">
            ...
            <select
              ...
              onChange={(e) =>
                handleScheduleChange({ type: e.target.value as ScheduleConfig['type'] })
              }
            >
          ...
          {trigger.config.schedule.type === 'interval' && (
            <div className="config-row">
              ...
              <input
                ...
                onChange={(e) =>
                  handleScheduleChange({ intervalMinutes: parseInt(e.target.value) })
                }
              />
              <span>minutes</span>
            </div>
            ...
            <select
              ...
              onChange={(e) =>
                onChange({
                  ...
                  config: {
                    ...trigger.config,
                    changeType: e.target.value as 'any' | 'value' | 'formula',
                  },
                })
              }
            >
