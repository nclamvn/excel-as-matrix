...
const ALL_FUNCTIONS = [
  ...
  },
  {
    ...
    desc: 'Returns the average of arguments',
  },
  {
    name: 'COUNT',
    category: 'Math',
  ...
  },
  {
    ...
    desc: 'Returns the maximum value',
  },
  {
    name: 'MIN',
    category: 'Math',
    syntax: 'MIN(number1, [number2], ...)',
    desc: 'Returns the minimum value',
  },
  {
    name: 'ROUND',
    category: 'Math',
    syntax: 'ROUND(number, num_digits)',
    desc: 'Rounds to specified digits',
  },
  ...
  { name: 'SQRT', category: 'Math', syntax: 'SQRT(number)', desc: 'Returns square root' },
  {
    ...
    desc: 'Returns number raised to power',
  },
  ...
  { name: 'RAND', category: 'Math', syntax: 'RAND()', desc: 'Returns random number 0-1' },
  {
    ...
    desc: 'Random integer between values',
  },
  ...
  },
  {
    ...
    desc: 'Returns middle characters',
  },
  ...
  },
  {
    ...
    desc: 'Returns TRUE if all true',
  },
  {
    name: 'OR',
    category: 'Logical',
    syntax: 'OR(logical1, [logical2], ...)',
    desc: 'Returns TRUE if any true',
  },
  ...
  { name: 'HOUR', category: 'Date', syntax: 'HOUR(serial_number)', desc: 'Returns hour' },
  {
    ...
    desc: 'Returns day of week',
  },
  {
    name: 'EDATE',
    category: 'Date',
    syntax: 'EDATE(start_date, months)',
    desc: 'Date plus months',
  },
  {
    name: 'EOMONTH',
    category: 'Date',
  ...
  },
  {
    ...
    desc: 'Returns value at position',
  },
  {
    name: 'MATCH',
    category: 'Lookup',
    syntax: 'MATCH(lookup_value, lookup_array, [match_type])',
    desc: 'Returns position',
  },
  {
    name: 'CHOOSE',
    category: 'Lookup',
    syntax: 'CHOOSE(index_num, value1, [value2], ...)',
    desc: 'Chooses from list',
  },
  {
    name: 'INDIRECT',
    category: 'Lookup',
    syntax: 'INDIRECT(ref_text)',
    desc: 'Returns reference from text',
  },
  {
    name: 'OFFSET',
    category: 'Lookup',
    syntax: 'OFFSET(reference, rows, cols, [height], [width])',
    desc: 'Returns offset reference',
  },
  ...
  },
  {
    ...
    desc: 'Counts with multiple criteria',
  },
  {
    name: 'SUMIF',
    category: 'Statistical',
    syntax: 'SUMIF(range, criteria, [sum_range])',
    desc: 'Sums cells meeting criteria',
  },
  {
    name: 'SUMIFS',
    category: 'Statistical',
    syntax: 'SUMIFS(sum_range, range1, criteria1, ...)',
    desc: 'Sums with multiple criteria',
  },
  {
    name: 'AVERAGEIF',
    category: 'Statistical',
    syntax: 'AVERAGEIF(range, criteria, [average_range])',
    desc: 'Average with criteria',
  },
  {
    name: 'MEDIAN',
    category: 'Statistical',
  ...
  },
  {
    ...
    desc: 'Returns k-th largest',
  },
  {
    name: 'SMALL',
    category: 'Statistical',
    syntax: 'SMALL(array, k)',
    desc: 'Returns k-th smallest',
  },
  {
    name: 'RANK',
    category: 'Statistical',
