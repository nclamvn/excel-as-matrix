...
const FEATURES = [
  {
    ...
    description: 'Not just autocomplete — a copilot that reads your formulas, understands dependencies, and explains its reasoning.',
  },
  {
    icon: <Table2 size={24} className="text-blue-500" />,
    title: '162 Formula Functions',
    description: 'Every Excel function you rely on — from VLOOKUP to LAMBDA — plus AI-powered natural language formulas.',
  },
  {
    icon: <Shield size={24} className="text-emerald-500" />,
    title: 'Enterprise Security',
    description: 'SOC2 controls, PII redaction, field-level encryption, SCIM provisioning, and immutable audit logs.',
  },
  {
    icon: <Zap size={24} className="text-amber-500" />,
    title: 'Workflow Automation',
    description: 'Record macros, build workflows in plain English, trigger via webhooks. No VBA required.',
  },
  {
    icon: <Globe size={24} className="text-cyan-500" />,
    title: 'Works Everywhere',
    description: 'PWA with offline mode, mobile grid, and real-time collaboration. Your spreadsheet, anywhere.',
  },
  {
    icon: <Users size={24} className="text-rose-500" />,
    title: 'Real-Time Collaboration',
    description: 'CRDT-based conflict resolution, presence indicators, threaded comments, and track changes.',
  },
];
...
const COMPARISON: ComparisonRow[] = [
  { feature: 'AI Copilot (built-in)', excelai: 'yes', excel: 'partial', sheets: 'partial', airtable: 'no' },
  { feature: 'Natural Language Formulas', excelai: 'yes', excel: 'no', sheets: 'no', airtable: 'no' },
  ...
  { feature: 'Real-Time Collaboration', excelai: 'yes', excel: 'yes', sheets: 'yes', airtable: 'yes' },
  ...
  { feature: 'Workflow Automation', excelai: 'yes', excel: 'partial', sheets: 'partial', airtable: 'yes' },
  ...
  { feature: 'Immutable Audit Log', excelai: 'yes', excel: 'no', sheets: 'partial', airtable: 'partial' },
  { feature: 'SCIM Provisioning', excelai: 'yes', excel: 'yes', sheets: 'yes', airtable: 'yes' },
  { feature: 'Data Residency (EU/US/APAC)', excelai: 'yes', excel: 'yes', sheets: 'partial', airtable: 'partial' },
...
export const CompetitiveLanding: React.FC<CompetitiveLandingProps> = ({ onEnterApp, onViewPricing }) => {
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-neutral-100">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm text-neutral-500">
            ...
            <a href="#comparison" className="hover:text-neutral-900 transition-colors">Compare</a>
            {onViewPricing && <button type="button" onClick={onViewPricing} className="hover:text-neutral-900 transition-colors">Pricing</button>}
          </div>
          <button type="button"
            onClick={onEnterApp}
      ...
      <section className="pt-20 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-neutral-500 max-w-2xl mx-auto mb-8">
            Every formula function you know. AI that understands your data.
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <a href="#comparison" className="px-6 py-3 text-neutral-600 font-medium hover:text-neutral-900 transition-colors">
              See Comparison
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {FEATURES.map((feature) => (
              <div key={feature.title} className="bg-white rounded-xl p-6 shadow-sm border border-neutral-100">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-neutral-200">
                  ...
                  <th className="text-center py-3 px-4 font-semibold text-emerald-700 bg-emerald-50/50">ExcelAI</th>
                  <th className="text-center py-3 px-4 font-medium text-neutral-500">Excel 365</th>
                  <th className="text-center py-3 px-4 font-medium text-neutral-500">Google Sheets</th>
              ...
              <tbody>
                {COMPARISON.map((row) => (
                  <tr key={row.feature} className="border-b border-neutral-100 hover:bg-neutral-50">
                    ...
                    <td className="py-2.5 px-4 text-center bg-emerald-50/30"><CellValue value={row.excelai} highlight /></td>
                    <td className="py-2.5 px-4 text-center"><CellValue value={row.excel} /></td>
                    <td className="py-2.5 px-4 text-center"><CellValue value={row.sheets} /></td>
                    <td className="py-2.5 px-4 text-center"><CellValue value={row.airtable} /></td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            {[
              ...
              <div key={badge.label} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 text-sm">
      ...
      <section className="py-20 px-6 text-center">
        ...
        <p className="text-neutral-500 mb-8 max-w-lg mx-auto">
          Import your existing .xlsx files. Start with the free plan.
...
const CellValue: React.FC<{ value: ComparisonValue; highlight?: boolean }> = ({ value, highlight }) => {
  if (value === 'yes') {
    return <Check size={16} className={highlight ? 'text-emerald-600 mx-auto' : 'text-emerald-500 mx-auto'} />;
  }
  if (value === 'no') {
  ...
  // Text value (e.g., "162")
  return <span className={`text-xs font-mono ${highlight ? 'font-semibold text-emerald-700' : 'text-neutral-600'}`}>{value}</span>;
};
