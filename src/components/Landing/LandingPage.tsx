  ...
  return (
    <div className="landing-page">
        ...
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <pattern id="circuit" width="120" height="120" patternUnits="userSpaceOnUse">
              ...
              <path
                d="M 60 0 L 60 58 M 0 60 L 58 60 M 62 60 L 120 60 M 60 62 L 60 120"
                fill="none"
                stroke="#d1d5db"
                strokeWidth="0.5"
              />
      ...
      <nav className="landing-nav">
        ...
        <button type="button" className="nav-cta" onClick={onEnterApp}>
          Get Started
        </button>
      </nav>
      ...
      <main className="landing-main">
        ...
        <section className="hero">
          ...
          <div className="floating-icons">
            ...
            <div className="floating-icon excel">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M21.17 3.25q.33 0 .59.25.24.24.24.58v15.84q0 .34-.24.58-.26.25-.59.25H7.83q-.33 0-.59-.25-.24-.24-.24-.58V17H2.83q-.33 0-.59-.24-.24-.25-.24-.59V7.83q0-.33.24-.59.26-.24.59-.24H7V4.08q0-.34.24-.58.26-.25.59-.25h13.34M7 13.06l1.18 2.22h1.79L8 12.06l1.93-3.17H8.22l-1.18 2.17-1.18-2.17H4.07l1.93 3.17-1.96 3.22h1.79l1.17-2.22M19 11h-5v1h5v-1m0-4h-5v1h5V7m0 8h-5v1h5v-1" />
              </svg>
            </div>
            ...
            <div className="floating-icon slide">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M10 8v8l5-4-5-4zm11-5H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14z" />
              </svg>
            </div>
            <div className="floating-icon word">
              <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <h1>
            ...
            <br />
            <span>AI-Powered</span> Office Suite
          </h1>
          <p>
            Transform documents, spreadsheets, and presentations with intelligent AI. Work smarter,
            not harder.
          </p>
          ...
          <div className="preview-container">
            ...
            <div className="preview-sidebar">
              ...
              <div className="sidebar-section">
                ...
                <div className="sidebar-sub-item active">Data Insights</div>
              </div>
            </div>
                  ...
                  <div className="stats-chart">
                    {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day, i) => (
                      <div key={day} className="stats-bar-group">
                        <div
                          className="stats-bar"
                          style={{ height: `${[45, 60, 35, 55, 70, 25, 40][i]}px` }}
                        />
        ...
        <section className="products-section" id="products">
          ...
          <p>
            Three powerful AI-driven applications to revolutionize how you work with documents,
          ...
          <div className="products-grid">
            ...
            <div className="product-card coming-soon">
              ...
              <h3>WordAI</h3>
              <p>
                Intelligent document creation with AI-powered writing, editing, and formatting.
                Create professional documents in seconds.
              </p>
              <ul className="product-features">
                <li>
                  <CheckIcon /> AI-powered writing assistant
                </li>
                <li>
                  <CheckIcon /> Smart formatting & templates
                </li>
                <li>
                  <CheckIcon /> Real-time collaboration
                </li>
                <li>
                  <CheckIcon /> Grammar & style correction
                </li>
              </ul>
              <button type="button" className="product-card-btn disabled">
                Notify Me
              </button>
            </div>
            ...
            <div className="product-card featured">
              ...
              <h3>ExcelAI</h3>
              <p>
                Next-generation spreadsheet with AI-native features. Natural language formulas,
                auto-visualization, intelligent data cleaning.
              </p>
              <ul className="product-features">
                <li>
                  <CheckIcon /> Natural Language Formulas
                </li>
                <li>
                  <CheckIcon /> Proactive AI Suggestions
                </li>
                <li>
                  <CheckIcon /> One-click Data Cleaning
                </li>
                <li>
                  <CheckIcon /> Smart Auto-Visualization
                </li>
                <li>
                  <CheckIcon /> AI Macros & Automation
                </li>
              </ul>
            ...
            <div className="product-card coming-soon">
              ...
              <h3>SlideAI</h3>
              <p>
                Create stunning presentations with AI. Generate slides from text, auto-design
                layouts, and add smart animations instantly.
              </p>
              <ul className="product-features">
                <li>
                  <CheckIcon /> AI slide generation
                </li>
                <li>
                  <CheckIcon /> Smart layout suggestions
                </li>
                <li>
                  <CheckIcon /> Auto-animations
                </li>
                <li>
                  <CheckIcon /> Presenter AI coach
                </li>
              </ul>
              <button type="button" className="product-card-btn disabled">
                Notify Me
