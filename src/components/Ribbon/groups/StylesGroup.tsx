...
export const StylesGroup: React.FC = () => {
  ...
  return (
    <RibbonGroup label="Styles">
        ...
        <RibbonDropdown
          ...
          options={[
            ...
            },
            {
              ...
              onClick: () => {
                clearFormat();
                showToast('Rules cleared', 'success');
              },
            },
            {
              id: 'manage-rules',
          ...
          options={[
            {
              id: 'light',
              label: 'Light',
              onClick: () => applyStyle('Light Table', { backgroundColor: '#f5f5f5' }),
            },
            {
              id: 'medium',
              label: 'Medium',
              onClick: () => applyStyle('Medium Table', { backgroundColor: '#e3f2fd' }),
            },
            {
              id: 'dark',
              label: 'Dark',
              onClick: () =>
                applyStyle('Dark Table', { backgroundColor: '#424242', textColor: '#ffffff' }),
            },
          ]}
        />
        <RibbonDropdown
          ...
          options={[
            {
              ...
              onClick: () => {
                clearFormat();
                showToast('Applied Normal style', 'success');
              },
            },
            {
              id: 'good',
              label: 'Good',
              onClick: () =>
                applyStyle('Good', { backgroundColor: '#c8e6c9', textColor: '#2e7d32' }),
            },
            {
              id: 'bad',
              label: 'Bad',
              onClick: () =>
                applyStyle('Bad', { backgroundColor: '#ffcdd2', textColor: '#c62828' }),
            },
            {
              id: 'neutral',
              label: 'Neutral',
              onClick: () =>
                applyStyle('Neutral', { backgroundColor: '#fff9c4', textColor: '#f57f17' }),
            },
          ]}
        />
      </div>
      ...
      {showCFDialog && <ConditionalFormattingDialog onClose={() => setShowCFDialog(false)} />}
    </RibbonGroup>
  );
};
