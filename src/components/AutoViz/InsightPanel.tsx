  ...
  return (
    <div className="insight-panel">
      {displayedInsights.map((insight) => (
        <div key={insight.id} className={`insight-item ${IMPORTANCE_STYLES[insight.importance]}`}>
          <div className="insight-icon" style={{ color: INSIGHT_COLORS[insight.type] }}>
          ...
          <div className="insight-content">
            ...
            {insight.value !== undefined && (
              <div className="insight-value">
                <span className="value-label">{language === 'vi' ? 'Giá trị:' : 'Value:'}</span>
