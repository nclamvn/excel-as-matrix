...
const FUNCTION_METADATA: Record<string, { description: string; category: string; syntax: string }> =
  {
    ...
    SUMIF: {
      description: 'Adds cells meeting criteria',
      category: 'Math',
      syntax: 'SUMIF(range, criteria, [sum_range])',
    },
    SUMIFS: {
      description: 'Adds cells meeting multiple criteria',
      category: 'Math',
      syntax: 'SUMIFS(sum_range, criteria_range1, criteria1, ...)',
    },
    COUNTIF: {
      description: 'Counts cells meeting criteria',
      category: 'Math',
    ...
    AVERAGEIF: {
      description: 'Averages cells meeting criteria',
      category: 'Math',
    ...
    CONCAT: {
      description: 'Joins text strings or ranges',
      category: 'Text',
      syntax: 'CONCAT(text1, [text2], ...)',
    },
    TEXTJOIN: {
      description: 'Joins with delimiter',
      category: 'Text',
    ...
    REPLACE: {
      description: 'Replaces text by position',
      category: 'Text',
      syntax: 'REPLACE(old_text, start, num_chars, new_text)',
    },
    FIND: {
      description: 'Finds text position (case-sensitive)',
      category: 'Text',
      syntax: 'FIND(find_text, within_text, [start])',
    },
    SEARCH: {
      description: 'Finds text position (case-insensitive)',
      category: 'Text',
    ...
    AND: {
      description: 'TRUE if all conditions true',
      category: 'Logical',
      syntax: 'AND(logical1, [logical2], ...)',
    },
    OR: {
      description: 'TRUE if any condition true',
      category: 'Logical',
    ...
    DATE: {
      description: 'Creates date from parts',
      category: 'Date',
    ...
    EDATE: {
      description: 'Date months before/after',
      category: 'Date',
    ...
    HLOOKUP: {
      ...
      category: 'Lookup',
      syntax: 'HLOOKUP(lookup_value, table, row_index, [range_lookup])',
    },
    XLOOKUP: {
      description: 'Advanced lookup',
      category: 'Lookup',
      syntax: 'XLOOKUP(lookup_value, lookup_array, return_array, ...)',
    },
    INDEX: {
      description: 'Value at row/col position',
      category: 'Lookup',
    ...
    CHOOSE: {
      description: 'Chooses from list',
      category: 'Lookup',
      syntax: 'CHOOSE(index_num, value1, [value2], ...)',
    },
    OFFSET: {
      description: 'Reference offset from cell',
      category: 'Lookup',
    ...
    RANK: {
      description: 'Rank of number',
      category: 'Statistical',
      syntax: 'RANK(number, ref, [order])',
    },
    PERCENTILE: {
      description: 'Value at percentile',
      category: 'Statistical',
    ...
    // Array
    SORT: {
      description: 'Sorts range or array',
      category: 'Array',
      syntax: 'SORT(array, [sort_index], [sort_order], [by_col])',
    },
    SORTBY: {
      description: 'Sorts by another array',
      category: 'Array',
      syntax: 'SORTBY(array, by_array1, [sort_order1], ...)',
    },
    FILTER: {
      description: 'Filters by conditions',
      category: 'Array',
    ...
    SEQUENCE: {
      description: 'Generates sequence',
      category: 'Array',
    ...
    // Lambda
    LAMBDA: {
      description: 'Creates custom function',
      category: 'Lambda',
      syntax: 'LAMBDA(parameter1, ..., calculation)',
    },
    LET: {
      description: 'Names calculation results',
      category: 'Lambda',
      syntax: 'LET(name1, value1, ..., calculation)',
    },
    MAP: {
      description: 'Applies LAMBDA to each element',
      category: 'Lambda',
      syntax: 'MAP(array1, ..., LAMBDA)',
    },
    REDUCE: {
      description: 'Reduces array to value',
      category: 'Lambda',
      syntax: 'REDUCE(initial_value, array, LAMBDA)',
    },
    SCAN: {
      description: 'Scans with running total',
      category: 'Lambda',
      syntax: 'SCAN(initial_value, array, LAMBDA)',
    },
    MAKEARRAY: {
      description: 'Creates array with LAMBDA',
      category: 'Lambda',
      syntax: 'MAKEARRAY(rows, cols, LAMBDA)',
    },
    BYROW: {
      description: 'Applies LAMBDA to each row',
      category: 'Lambda',
      syntax: 'BYROW(array, LAMBDA)',
    },
    BYCOL: {
      description: 'Applies LAMBDA to each column',
      category: 'Lambda',
      ...
      if (score > 0) {
        scored.push({
          suggestion: {
            ...
            syntax:
              item.type === 'lambda' && item.parameters
