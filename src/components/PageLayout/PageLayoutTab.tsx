      ...
      <div className="layout-section">
        ...
        {activePanel === 'margins' && (
          <div className="dropdown-panel margins-panel">
            ...
            <button type="button" className="apply-button" onClick={handleCustomMargins}>
      ...
      <div className="layout-section">
        ...
        {activePanel === 'size' && (
          <div className="dropdown-panel size-panel">
            ...
            <button type="button" className="apply-button" onClick={handleCustomSize}>
              Apply Custom Size
            </button>
          </div>
        )}
        ...
        {activePanel === 'printArea' && (
          <div className="dropdown-panel print-area-panel">
            ...
            <div className="print-area-input-group">
              ...
              />
              <button type="button" className="set-button" onClick={handleSetPrintArea}>
                Set
              </button>
            </div>
          </div>
      ...
      <div className="layout-section">
        ...
        {activePanel === 'printTitles' && (
          <div className="dropdown-panel print-titles-panel">
            ...
            <button type="button" className="apply-button" onClick={handleSetPrintTitles}>
              Apply Print Titles
            </button>
          </div>
        )}
