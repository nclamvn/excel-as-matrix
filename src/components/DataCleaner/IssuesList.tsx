...
export const IssuesList: React.FC<IssuesListProps> = ({ issues, onIssueClick, onFixIssue }) => {
...
const IssueItem: React.FC<IssueItemProps> = ({ issue, isExpanded, onToggle, onClick, onFix }) => (
  <div className={`issue-item issue-item--${issue.severity}`}>
    <div className="issue-item__header" onClick={onToggle}>
      ...
      {issue.autoFixable && <span className="issue-item__auto-fix-badge">Auto-fixable</span>}
    ...
    {isExpanded && (
      <div className="issue-item__details">
          ...
          <div className="issue-item__examples">
            ...
            {issue.examples.slice(0, 3).map((example, i) => (
              <div key={i} className="issue-item__example">
                ...
                <span className="issue-item__example-value">{String(example.currentValue)}</span>
        ...
        <div className="issue-item__actions">
          <button type="button" className="issue-item__action" onClick={() => onClick?.(issue)}>
            View Details
          </button>
          {issue.autoFixable && (
            <button
